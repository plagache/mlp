...
- [**topo_sort** function](tensor.py#L62) given a graph of operations return the list of computed elements
- [**backward** function](tensor.py#L79) uses operation chain rules to compute each element's gradient
